...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		*/
		...
		/*System.out.println(faculty.courseFacultyMapping(new CourseFacultyMapping(1,1)));
		faculty.courseFacultyMapping(new CourseFacultyMapping(1,2));
		faculty.courseFacultyMapping(new CourseFacultyMapping(1,3));
		faculty.courseFacultyMapping(new CourseFacultyMapping(2,2));
		faculty.courseFacultyMapping(new CourseFacultyMapping(2,3));*/
		//System.out.println(faculty.getFacultyNotMappedWithCourse(new CourseMaster(4,"javascript")));
