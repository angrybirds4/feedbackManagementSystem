...
public class AddEmployee {
	...
	public static void main(String[] args) {
		...
		/*
		 * employee = new
		 * Employee(generateRandomId(),"Mubeena","mubeena123","Co-ordinator"); id =
		 * employeeDAO.addEmployee(employee);
		 * System.out.println("employee has inserted with the id: " + id);
		 * 
		 * employee = new
		 * Employee(generateRandomId(),"Abhishek Kumar","abhi123","Admin"); id =
		 * employeeDAO.addEmployee(employee);
		 * System.out.println("employee has inserted with the id: " + id);
		 * 
		 * employee = new
		 * Employee(generateRandomId(),"Rajesh Kumar","raj123","Participant"); id =
		 * employeeDAO.addEmployee(employee);
		 * System.out.println("employee has inserted with the id: " + id);
		 * 
		 * 
		 * employee = new
		 * Employee(generateRandomId(),"Shushanthika","shushanthika123","Participant");
		 * id = employeeDAO.addEmployee(employee);
		 * System.out.println("employee has inserted with the id: " + id);
		 * 
		 * /*employee = new
		 * Employee(generateRandomId(),"Keerthi","keerthi123","Participant"); >>>>>>>
		 * branch 'master' of
		 * https://github.com/rajesh226-gif/feedbackManagementSystem.git id =
		 * employeeDAO.addEmployee(employee);
		 * System.out.println("employee has inserted with the id: " + id);
		 */
