...
/*	@Test
	void courseFacultyMappingTest() {
		Boolean actualResult =  facultyMaintenanceService.courseFacultyMapping(new CourseFacultyMapping(75690,54079));    
		Boolean expectedResult = true;
		assertEquals(expectedResult, actualResult.toString());
		actualResult =  facultyMaintenanceService.courseFacultyMapping(new CourseFacultyMapping(89750,54435));    
		expectedResult = true;
		assertEquals(expectedResult, actualResult.toString());
		actualResult =  facultyMaintenanceService.courseFacultyMapping(new CourseFacultyMapping(34356,65784));    
		expectedResult = true;
		assertEquals(expectedResult, actualResult.toString());
	}
	@Test
	void getMappedFacultyWithCourseTest() {
		ArrayList<Faculty> actualResult =  facultyMaintenanceService.getMappedFacultyWithCourse(76789);            //have to add
		String expectedResult = "Will insert";
		assertEquals(expectedResult, actualResult.toString());
	}
	
	@Test
	void getFacultyNotMappedWithCourseTest() {
		ArrayList<Faculty> actualResult =  facultyMaintenanceService.getFacultyNotMappedWithCourse(new CourseMaster()); //have to add
		String expectedResult = "Will insert";
		assertEquals(expectedResult, actualResult.toString());
	}*/
}
